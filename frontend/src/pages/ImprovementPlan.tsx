...
import { Clock, Lock, Flame, PlayCircle, Trophy } from 'lucide-react'
...
export default function ImprovementPlan() {
    ...
    const progressPct = plan.length > 0 ? Math.round((totalMastered / plan.length) * 100) : 0
                ...
                <div style={{ maxWidth: 800, margin: '60px auto', textAlign: 'center' }}>
                    ...
                    <div style={{ marginTop: 40, padding: 30, background: 'rgba(59,130,246,0.03)', borderRadius: 20, border: '1px dashed var(--border)' }}>
                        ...
                        <ul style={{ textAlign: 'left', display: 'inline-block', margin: '0 auto', fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.8 }}>
                            <li>• Adaptive study plans based on detected skill gaps</li>
                            <li>• Market forecast insights for your target role</li>
                            <li>• Integrated AI Study Hub for skill verification</li>
                            <li>• Level-based locking system for structured learning</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                            ...
                            <div style={{ flex: 1 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 2 }}>
                                    ...
                                    <span style={{ fontSize: 12, color: 'var(--green)', fontWeight: 700 }}>+{aiForecast.growth_pct}% Opportunity</span>
                                </div>
